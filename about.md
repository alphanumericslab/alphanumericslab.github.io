...
In my experience, different regions cultivate this transformation in different ways. In Europe and some other academic systems, PhD students often work on highly focused, well-defined research questions. Progress is measured based on specific program milestones—number and quality of publications, presentations, committee approvals—and once those are met, the path to defense is usually straightforward. The emphasis is on depth and individual contribution.

In the U.S. and similar systems, the PhD experience tends to be embedded in broader, collaborative lab efforts that align with institutional or even national priorities. You're not only solving a specific problem but also building tools, software, systems, or knowledge that extend beyond your dissertation. You're part of a team, contributing to a longer-term goal. In this model, the principal investigator's role is similar to that of a startup leader—constantly balancing grant writing, human resource management, strategic planning, and delivery. Your progress is intertwined with that ecosystem, and your work both depends on and supports the success of others.

There is no universal answer to the question of *when* to defend. You must meet the program's formal requirements and advisor's expectations and project commitments, but beyond that, it's a strategic decision—one that should align with your next steps. If you're targeting academic jobs or postdocs, defending earlier might help you enter the market at the right time. If you prefer to explore other avenues, there may be value in staying enrolled while finalizing applications, securing funding, or wrapping up publications. These decisions are not only academic or professional—they're personal. Life circumstances such as health, family, financial security, or immigration status may also play a major role. Share these with me early. Knowing your trajectory helps me plan ahead—whether for project continuity, lab funding, or future opportunities. The same applies to internships: please communicate your interests and timelines in advance so I can align lab work accordingly.

The PhD process is intellectually demanding and emotionally complex—don't carry the burden alone. If you're feeling disconnected from your project, struggling with your topic, or questioning whether this lab is right for you, speak up. We can explore adjustments, plan transitions, or even shift directions if needed. There are always options, and I'm here to help you find your path and move forward.


### Mentorship and Meetings
Mentorship is adjusted based on your year in the program. Junior students (undergraduate and master's students) get more frequent mentorship. For PhD students, in Year 1, we will have weekly one-on-one meetings. In Year 2, biweekly. Year 3, every three weeks. From Year 4 onward, we'll meet monthly (at that point through your PhD, you wouldn't want to meet with me that often anyway...). These are your one-on-one meetings with the PI and do not include research team meetings, classes, or general office hours. If you need extra time with me outside of these for research or non-research-related talks, reach out and we'll schedule it.
...
LLMs (like ChatGPT, GitHub Copilot, and others) are indeed helpful and time saving for writing, coding, brainstorming, and summarizing. You are welcome to use them where appropriate. But use them *intentionally* and with caution.

LLMs should *not* replace your essential skills—research design, scientific reasoning, problem solving, coding, writing, critical thinking, or professional communication. These are core to your future career success, and tools cannot replace them. You're training to become a *doctor of philosophy*—someone who can independently design and evaluate research, generate ideas, and execute them. If you outsource that to an LLM, you're not learning the skills you need—and when everyone else has access to the same AI-powered tools, you become replaceable.

LLMs are not a shortcut to expertise. Use them as accelerators, not substitutes, and make sure to obtain the skills to evaluate their outputs.

The AI landscape is evolving very rapidly; but in my opinion, the academic and professional world still demands real fluency in theory, research, engineering and technical writing. If you graduate without mastering these, you'll find yourself outpaced by peers who practiced problem solving, thinking critically, and collaborating meaningfully. Use LLMs to support your learning and building irreplaceable skills.
...
Your code should not be written in isolation. It should be usable by the next person who joins the project and should be readable in the future by yourself and others. That means clean structure, documentation, modular design, and no reliance on local setups or local libraries. All data and code repositories must have a README file with the project title, contributors, setup/utilization procedures required to run the code, and a license file. No need for over-documentation. Just write it for your future self (in a week or months from now). We typically use the [BSD 3-Clause License](https://en.wikipedia.org/wiki/BSD_licenses) for our codebases, unless specified by the PI. Systematic programming is part of being a researcher, not just a coder.
